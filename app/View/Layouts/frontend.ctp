...
<head>
  <meta charset="utf-8">
  <title>XtraRide RV Warranty - Eagle Vision RV</title>
  ...
  <link href="<?php echo THEME_PATH;?>assets/frontend/pages/css/style-revolution-slider.css" rel="stylesheet"><!-- xtraridewarranty revo slider styles -->
...
<body class="corporate">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li><i class="fa fa-envelope-o"></i><span>info@xtraridewarranty.com/</span></li>
                    </ul>
                </div>
            </div>
        </div>        
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="<?= SITE_URL;?>"><img src="https://xtraridewarranty.com/wp-content/uploads/2017/10/EagleEyeRV-06-01.png" alt="XtraRide RV Warranty Portal"></a>
        ...
        <div class="header-navigation pull-right font-transform-inherit">
          <ul>
            <li class="dropdown">
              <a href="https://xtraridewarranty.com/">
                Home   
              </a>
            </li>
			 <li class="dropdown">
			 ...
			 <li class="dropdown">
              <a href="<?= SITE_URL; ?>users/get_quote"> 
              Get Quote
              </a>
            </li>
			 <li class="dropdown">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 pre-footer-col">
            ...
            <address class="margin-bottom-40">
              ...
              Fax: 300 323 1456<br>
              Email: <a href="mailto:info@xtraridewarranty.com">info@xtraridewarranty.com</a><br>
              Skype: <a href="skype:xtraridewarranty">xtraridewarranty</a>
            </address>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 padding-top-10">
            2018 © xtraridewarranty Shop UI. ALL Rights Reserved. <a href="javascript:;">Privacy Policy</a> | <a href="javascript:;">Terms of Service</a>
          </div>
