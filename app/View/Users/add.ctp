              ...
              <div class="row">
				...
				<?php echo $this->Form->create('User',array('class'=>'form-horizontal form-without-legend')); ?>
                    <div class="form-group">
                      <label for="email" class="col-lg-4 control-label">Full Name <span class="require">*</span></label>
                      <div class="col-lg-8">
					  <?php echo $this->Form->input('name', array('class'=>'form-control','placeholder'=>'Enter your Name','label'=>false,'type'=>'text')); ?>
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20">
                       <?php echo $this->Form->end(__('Add Me As Admin')); ?>
                      </div>
                    </div>
                  </form>
                </div>
